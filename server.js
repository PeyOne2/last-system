...
setInterval(() => {
  http.get(`http://${process.env.ssssssssss0000000000}.glitch.me/`);
}, 280000);
...
const youtube = new YouTube("AIzaSyAJ08c_oT36pPCIpC7f325vHOlO0aC81IU"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyAJ08c_oT36pPCIpC7f325vHOlO0aC81IU"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@728620741125341244>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content === "كود") {
    message.channel.send("**:heart:قريبا سيرفر ارك باذن الله:heart:**");
    message.channel.sendFile("");
  }
});
    ...
    async function handleVideo(video, msg, voiceChannel, playlist = false) {
      ...
      if (!serverQueue) {
        const queueConstruct = {
          ...
          volume: 60, //// تعديل درجة الصوت الاساسية
